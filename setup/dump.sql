...
/* Trigger structure for table `venues_settings` */

DELIMITER $$

/*!50003 CREATE */  /*!50003 TRIGGER `venues_settings__add_default_values__on_insert` AFTER INSERT ON `venues_settings` FOR EACH ROW BEGIN
	UPDATE venues_settings SET venue_rating_category_mapping = '{"venue_rating_cat_1":"Service","venue_rating_cat_2":"Staff","venue_rating_cat_3":"Facility","venue_rating_cat_4":"Custom 1","venue_rating_cat_5":"Custom 2","venue_rating_cat_6":"Custom 3"}'
